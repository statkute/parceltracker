    ...
    var body: some View {
        ZStack {
            Capsule()
                ...
                .foregroundColor(Color(colorScheme == .dark ? UIColor.secondarySystemBackground : UIColor.secondaryLabel)).opacity(0.4)
    ...
    var body: some View {
        ZStack {
            Capsule()
                ...
                .foregroundColor(Color(UIColor.white).opacity(self.activeOnUpcomingFilterValue == self.selectedParcelFilter.filter ? 0.45 : 0))
                .cornerRadius(1.0)
